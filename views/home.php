...
$stmt = $conn->prepare("SELECT name, role, seller_verified, seller_motivation FROM users WHERE user_id = ?");
...
$_SESSION['name'] = $latest['name'] ?? 'User';
?>
...
<head>
    ...
    <style>
        ...
        .banner a { margin-left: 20px; text-decoration: none; font-weight: bold; color: #2b542c; }
...
<div class="main-content">
    ...
    <?php if ($_SESSION['seller_verified'] == 1): ?>
        <div class="banner">
            ...
            <a href="../controllers/BuyerDashboardController.php?action=browse">Start Bidding</a>
        </div>
